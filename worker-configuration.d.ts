/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 090acfe6248c96ab7f1195fbd6fe2525)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "Agent" | "AgentSQLite";
	}
	interface Env {
		NOTES_IMAGES: R2Bucket;
		...
		Agent: DurableObjectNamespace<import("./src/worker/index").AgentSQLite>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "OPENAI_API_KEY">> {}
}

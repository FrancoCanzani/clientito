import { openCompose as triggerOpenCompose } from "@/features/email/inbox/components/compose-events";
...
const ITEM_CLASSES =
  "flex cursor-pointer items-center gap-2 rounded-md px-3 py-1.5 text-xs transition-colors data-[selected=true]:bg-muted";

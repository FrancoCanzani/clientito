...
export function CommandPalette() {
 ...
 className="flex max-h-[min(72vh,40rem)] min-h-0 flex-col overflow-hidden rounded border border-border bg-background shadow-xl"
 >
 <div className="border-b border-border px-3 py-2">
 <div className="flex items-center gap-2">
 {showModeIndicator && (
 <span className="shrink-0 bg-muted px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-wide text-muted-foreground">

...
function SheetOverlay({
 ...
 className={cn(
 "fixed inset-0 z-50 bg-[oklch(12%_0.01_250)]/80 duration-100 supports-backdrop-filter:backdrop-blur-xs data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
 className,
 )}
 {...props}
 />

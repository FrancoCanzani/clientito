...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar rounded bg-background p-3 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(6)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",

...
export function SettingsShell({ children }: { children: ReactNode }) {
 ...
 <nav
 className="flex shrink-0 gap-1 overflow-x-auto border-b border-border/60 px-3 py-2 lg:hidden"
 aria-label="Settings"
 >
...
function SettingsNavGroup({
 ...
 to={item.to}
 params={{ mailboxId }}
 className="block px-3 py-1.5 text-xs text-muted-foreground transition-colors hover:bg-muted/60 hover:text-foreground"
 activeProps={{
 className: cn(
 "block px-3 py-1.5 text-xs font-medium",

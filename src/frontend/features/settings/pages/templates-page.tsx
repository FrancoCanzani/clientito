...
export default function TemplatesPage() {
 ...
 className="border border-border/60 bg-muted/40 px-2 py-1 font-mono text-[11px] text-muted-foreground transition-colors hover:border-foreground/30 hover:text-foreground"
 >
 {variable.token}
 </button>
 ))}
 ...
 <div className="border border-dashed border-border/70 p-6 text-xs text-muted-foreground">

      ...
      <MailboxPageBody className="overflow-y-auto">
        <div className="w-full px-3 py-3 md:px-6">
          {pendingQuery.isLoading ? (
            ...
            <ul className="overflow-hidden border border-border/70 bg-background/90">
                    ...
                    <div className="flex flex-col gap-3 px-3 py-3.5 sm:flex-row sm:items-start sm:justify-between sm:gap-4 sm:px-4">
                      ...
                      <div className="flex shrink-0 items-center gap-2 sm:pl-3">
                        <Button
                          ...
                          disabled={busy}
                          onClick={() =>
                            applyDecision(sender.fromAddr, "accept")
                          }
                        >
                          Accept
                        </Button>
                        <Button
                          ...
                          disabled={busy}
                          onClick={() =>
                            applyDecision(sender.fromAddr, "reject")
                          }
                        >
                          Reject
                        </Button>

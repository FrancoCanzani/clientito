...
export function ToolbarButton({
 ...
 onClick={onClick}
 className={`p-1 text-foreground transition-colors disabled:cursor-not-allowed disabled:opacity-40 ${
...
export function LinkEditor({
 ...
 className="h-7 w-56 bg-transparent px-1 text-xs text-foreground outline-none"
 />
 <button
 type="button"
 onMouseDown={(event) => event.preventDefault()}
 onClick={onSubmit}
 className="px-2 py-1 text-xs text-foreground transition-colors hover:bg-foreground/5"
 >
 Apply
 </button>
 {currentLink && (
 ...
 onMouseDown={(event) => event.preventDefault()}
 onClick={onCancel}
 className="px-2 py-1 text-xs text-muted-foreground transition-colors hover:bg-foreground/5"
 >
 Cancel
 </button>
 </div>

import { markEmailRead } from "@/features/email/mail/shared/mutations";
import { invalidateInboxQueries } from "@/features/email/mail/shared/data/invalidation";
import { fetchEmailDetail } from "@/features/email/mail/shared/data/thread-detail";
...
import { isInboxLabelView } from "@/features/email/mail/shared/views";

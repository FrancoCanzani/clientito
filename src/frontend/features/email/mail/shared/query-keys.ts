...
const NON_LIST_EMAIL_QUERY_SEGMENTS = new Set([
  "view-sync-meta",
  "inbox-unread-count",
  "view-counts",
  "search",
...
export function isEmailListQueryKey(queryKey: readonly unknown[]): boolean {
  return (
    queryKey[0] === "emails" &&
    typeof queryKey[1] === "string" &&
    !NON_LIST_EMAIL_QUERY_SEGMENTS.has(queryKey[1])
  );
}

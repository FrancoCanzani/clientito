...
export function DraftThreadMessage({ draft }: { draft: EmailThreadItem }) {
  ...
  return (
    <div className="rounded border border-destructive/30 bg-card shadow-xs">
      <div className="flex items-center gap-2 border-b border-destructive/20 px-4 py-3">
        ...
        <span className="font-mono text-xs tracking-tighter tabular-nums text-muted-foreground">

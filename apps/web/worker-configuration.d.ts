/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 69b3c51f55da9e2f9fbf0dc21e6a68c2)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CF_API_TOKEN: string;
		CHAT_AGENT: DurableObjectNamespace<import("./src/worker/index").ChatAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_SECRET" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "VITE_BETTER_AUTH_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "CF_API_TOKEN">> {}
}
